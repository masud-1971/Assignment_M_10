...
console.log("after subtraction : " + calculateDifference(a, b)); // For printing the result 
...
console.log(numberArray);               //print values of Array
console.log(`Smallest Number of the Array is: ${findMin(numberArray)}`);
